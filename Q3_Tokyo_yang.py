...
nn_model.add(Dense(8, activation='relu'))  # 添加第四个隐藏层，有8个神经元
nn_model.add(Dense(4, activation='relu'))  # 添加第五个隐藏层，有4个神经元
nn_model.add(Dense(1))
nn_model.compile(optimizer=Adam(learning_rate=0.01), loss='mean_squared_error')
nn_model.fit(X_train, Y_train, epochs=400, batch_size=4, verbose=0)  # 增加到300个epoch，batch_size为16
...
# future_X_nn = 0.8 * future_X_scaled
