...
plt.savefig('Q1/international_pca.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('Q1/population_tsne.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('Q1/predict_real_gdp.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.grid()
plt.savefig('Q1/gdp_residuals.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('Q1/processed_factor_heatmap.png', dpi=300, bbox_inches='tight')
plt.show()
...
# 去掉网格
plt.grid(False)
plt.savefig('Q1/processed_factor_coefficience.png', dpi=300, bbox_inches='tight')
plt.show()
